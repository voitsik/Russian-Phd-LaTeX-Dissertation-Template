...
\input{common/characteristic} % Характеристика работы по структуре во введении и в автореферате
...
{\textbf{Первая глава} посвящена исследованию видимого сдвига положения ядра в ультракомпактных
квазарах с частотой.
