...
\printbibliography[heading=authorpublications,keyword=biblioauthor,section=0]
\end{refcontext}
}
...
\begin{refcontext}
\printbibliography[resetnumbers,heading=otherpublications,keyword=biblioother]
\end{refcontext}
}
